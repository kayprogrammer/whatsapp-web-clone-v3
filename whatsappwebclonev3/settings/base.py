...
ROOT_URLCONF = 'whatsappwebclonev3.urls'
...
WSGI_APPLICATION = 'whatsappwebclonev3.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "WHATSAPP WEB CLONE V3 ADMIN",
    ...
    "welcome_sign": "Welcome to the Whatsapp Web Clone v3 Admin Section",

    # Copyright on the footer
    "copyright": "Whatsapp Web Clone v3 Ltd",
